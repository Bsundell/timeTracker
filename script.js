...
var formPage = document.getElementById("trackingForm");
var logPage = document.getElementById("timeLog");
...
submitWeek.addEventListener("click", function() {
    ...
    for (var i = 0, len = dayParameterArray.length; i < len; i++) {
        addEntry(dayParameterArray[i][0], dayParameterArray[i][1], dayParameterArray[i][2]);
    }

    function getTotalForWeek(arr) {
        var total = 0;
    ...
    for (var k = 0, leng = inputs.length; k < leng; k++) {
